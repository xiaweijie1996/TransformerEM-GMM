...
save_model = '/home/weijiexia/paper3/mmd_vit_exp_30/model/'
save_image = '/home/weijiexia/paper3/mmd_vit_exp_30/gen_img/'
lr = 0.0001
n_components = 6
...
wandb.init(project=f'{random_sample_num}_train', entity='xiaweijie1996')
