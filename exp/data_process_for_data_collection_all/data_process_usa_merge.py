...
data_type = 'grid' # 'grid', 'solar', 'solar2'
...
with open(f'exp/data_process_for_data_collection_all/new_data_15minute_{data_type}.pkl', 'wb') as f:
    pickle.dump(new_data, f)

with open(f'exp/data_process_for_data_collection_all/new_data_15minute_{data_type}.pkl', 'rb') as f:
...
for i in range(10):
    ...
    plt.legend()
plt.tight_layout()
plt.savefig(f'exp/data_process_for_data_collection_all/15minute_data_{data_type}.png')
