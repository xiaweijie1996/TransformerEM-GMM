...
save_model = '/home/weijiexia/paper3/em_trans_half/model/'
save_image = '/home/weijiexia/paper3/em_trans_half/gen_img/'
lr = 0.0001
n_components = 6
...
wandb.init(project=f'{random_sample_num}_30m_resolution', entity='xiaweijie1996')
...
for epoch in range(num_epochs):
    ...
    if epoch % 1 == 0:
        ...
        if _loss.item() < mid_loss:
            mid_loss = _loss.item()
            torch.save(encoder.state_dict(), save_model + f'30mr_encoder_{random_sample_num}_{_model_scale}.pth')
            torch.save(embedding_para, save_model + f'30mr_embedding_{random_sample_num}_{_model_scale}.pth')
            torch.save(emb_empty_token, save_model + f'30mr_emb_empty_token_{random_sample_num}_{_model_scale}.pth')
