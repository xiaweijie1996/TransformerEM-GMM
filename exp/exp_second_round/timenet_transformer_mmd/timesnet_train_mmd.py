...
#     # randomly select a window of size _window from the x and y tensors
#     _start = np.random.randint(0, L - _window)
#     x = x[:, _start:_start + _window]
#     y = y[:, _start:_start + _window]
