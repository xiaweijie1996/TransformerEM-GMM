...
save_model = 'exp/exp_second_round/solar_15minutes/model/'
save_image = 'exp/exp_second_round/solar_15minutes/gen_img/'
lr = 0.0001
n_components = 6
...
wandb.init(project=f'solar_{random_sample_num}_train_nomerge')
