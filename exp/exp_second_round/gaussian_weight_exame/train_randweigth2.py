...
save_model =  f'exp/exp_second_round/gaussian_weight_exame/fixedweights_randome2/'
save_image =  f'exp/exp_second_round/gaussian_weight_exame/fixedweights_randome2/'
lr = 0.0005
