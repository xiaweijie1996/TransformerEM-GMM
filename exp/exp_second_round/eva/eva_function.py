...
def create_plots(t_samples_list, r_samples_list, r_samples_part_list, timesnet_sample_list, timesnet_sample_mmd_list, path, label_fontsize=26, tick_fontsize=20):
    ...
    fig.text(0.5, 0.08, 'Hour of Day [-]', ha='center', fontsize=label_fontsize)
    fig.text(0.03, 0.5, 'Electricity Consumption [kWh]', va='center', rotation='vertical', fontsize=label_fontsize)
    ...
    fig.text(0.90, 0.5, 'Daily Consumption [kWh]', va='center', rotation='vertical', fontsize=label_fontsize)
