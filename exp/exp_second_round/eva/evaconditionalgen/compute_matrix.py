...
for random_sample_num_vae in [4, 8, 16, 32]:
    ...
    for i in tqdm(range(mean.shape[0])):
        # samples scaled
    ...
    print(f'mmd of {random_sample_num_vae}-shots: ', mmd/batch_size)
    print(f'kl of {random_sample_num_vae}-shots: ', kl/batch_size)
    print(f'ks of {random_sample_num_vae}-shots: ', ks/batch_size)
    print(f'ws of {random_sample_num_vae}-shots: ', ws/batch_size)
    print(f'msem of {random_sample_num_vae}-shots: ', msem/batch_size)
