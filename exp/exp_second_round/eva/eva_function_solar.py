...
def create_plots(t_samples_list, r_samples_list, r_samples_part_list, timesnet_sample_list, timesnet_sample_mmd_list, path, label_fontsize=26, tick_fontsize=20):
    ...
    for row in range(num_rows):
        ...
        norm = plt.Normalize(total_consumption.min(), total_consumption.max()*1.3)
    ...
    fig.text(0.5, -0.02, 'Hour of Day [-]', ha='center', fontsize=label_fontsize)
    fig.text(0.03, 0.5, 'Electricity Generation [kWh]', va='center', rotation='vertical', fontsize=label_fontsize)
